...
void MainWindow::on_actionSubscript_triggered()
{
    ...
    {
        if(mFont.bold()){
            ui->textBrowser->insertHtml("<sub><b>~<b></sub>");
        } else {
            ui->textBrowser->insertHtml("<sub>~</sub>");
        }
...
void MainWindow::on_actionSuperscript_triggered()
{
    ...
    {
        if(mFont.bold()){
            ui->textBrowser->insertHtml("<sup><b>~<b></sup>");
        } else {
            ui->textBrowser->insertHtml("<sup>~</sup>");
        }
